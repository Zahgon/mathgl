...
// it.
func NewVecNFromData(initial []float64) *VecN { _ = "STUB: not implemented"; return nil }
...
// will return NaN.
func (vn *VecN) Dot(other *VecN) float64 { _ = "STUB: not implemented"; return 0 }
...
func (vn *VecN) Len() float64 { _ = "STUB: not implemented"; return 0 }

// LenSqr returns the vector's square length. This is equivalent to the sum of the squares of all elements.
func (vn *VecN) LenSqr() float64 { _ = "STUB: not implemented"; return 0 }
...
//
// The destination can be vn itself and nothing will go wrong.
func (vn *VecN) Mul(dst *VecN, c float64) *VecN { _ = "STUB: not implemented"; return nil }
