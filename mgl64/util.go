...
func FloatEqual(a, b float64) bool { _ = "STUB: not implemented"; return false }
...
func Clamp(a, low, high float64) float64 { _ = "STUB: not implemented"; return 0 }

// ClampFunc generates a closure that returns its parameter
// clamped to the range [low,high].
func ClampFunc(low, high float64) func(float64) float64 { _ = "STUB: not implemented"; return nil }
...
func IsClamped(a, low, high float64) bool { _ = "STUB: not implemented"; return false }

// SetMin sets a to b if a > b.
func SetMin(a, b *float64) { _ = "STUB: not implemented"; return }

// SetMax sets a to b if a < b.
func SetMax(a, b *float64) { _ = "STUB: not implemented"; return }
...
func Round(v float64, precision int) float64 { _ = "STUB: not implemented"; return 0 }
