...
func Circle(radiusX, radiusY float64, numSlices int) []Vec2 { _ = "STUB: not implemented"; return nil }
...
func Rect(width, height float64) []Vec2 { _ = "STUB: not implemented"; return nil }
...
func BezierCurve2D(t float64, cPoints []Vec2) Vec2 { _ = "STUB: not implemented"; return *new(Vec2) }

// P += P_i * nCi * (1-t)^(n-i) * t^i

// BezierCurve3D same as the 2D version, except the line is in 3D space
func BezierCurve3D(t float64, cPoints []Vec3) Vec3 { _ = "STUB: not implemented"; return *new(Vec3) }
...
func choose(n, k int) int { _ = "STUB: not implemented"; return 0 }
