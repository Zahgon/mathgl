...
func (v Vec2) Vec3(z float32) Vec3 { _ = "STUB: not implemented"; return *new(Vec3) }

// Vec4 constructs a 4-dimensional vector by appending the given coordinates.
func (v Vec2) Vec4(z, w float32) Vec4 { _ = "STUB: not implemented"; return *new(Vec4) }

// Vec4 constructs a 4-dimensional vector by appending the given coordinates.
func (v Vec3) Vec4(w float32) Vec4 { _ = "STUB: not implemented"; return *new(Vec4) }
...
func (v1 Vec2) Mul(c float32) Vec2 { _ = "STUB: not implemented"; return *new(Vec2) }
...
func (v1 Vec2) Dot(v2 Vec2) float32 { _ = "STUB: not implemented"; return 0 }
...
// math.Hypot(v[0], v[1]).
func (v1 Vec2) Len() float32 { _ = "STUB: not implemented"; return 0 }

// LenSqr returns the vector's square length. This is equivalent to the sum of the squares of all elements.
func (v1 Vec2) LenSqr() float32 { _ = "STUB: not implemented"; return 0 }
...
// Mul performs a scalar multiplication between the vector and some constant value
// c. This is equivalent to iterating over every vector element and multiplying by c.
func (v1 Vec3) Mul(c float32) Vec3 { _ = "STUB: not implemented"; return *new(Vec3) }
...
// direction. If both vectors are normalized, the value will be -1 for opposite pointing,
// one for same pointing, and 0 for perpendicular vectors.
func (v1 Vec3) Dot(v2 Vec3) float32 { _ = "STUB: not implemented"; return 0 }

// Len returns the vector's length. Note that this is NOT the dimension of
// the vector (len(v)), but the mathematical length. This is equivalent to the square
// root of the sum of the squares of all elements. E.G. for a Vec2 it's
// math.Hypot(v[0], v[1]).
func (v1 Vec3) Len() float32 { _ = "STUB: not implemented"; return 0 }

// LenSqr returns the vector's square length. This is equivalent to the sum of the squares of all elements.
func (v1 Vec3) LenSqr() float32 { _ = "STUB: not implemented"; return 0 }
...
// Mul performs a scalar multiplication between the vector and some constant value
// c. This is equivalent to iterating over every vector element and multiplying by c.
func (v1 Vec4) Mul(c float32) Vec4 { _ = "STUB: not implemented"; return *new(Vec4) }
...
// direction. If both vectors are normalized, the value will be -1 for opposite pointing,
// one for same pointing, and 0 for perpendicular vectors.
func (v1 Vec4) Dot(v2 Vec4) float32 { _ = "STUB: not implemented"; return 0 }

// Len returns the vector's length. Note that this is NOT the dimension of
// the vector (len(v)), but the mathematical length. This is equivalent to the square
// root of the sum of the squares of all elements. E.G. for a Vec2 it's
// math.Hypot(v[0], v[1]).
func (v1 Vec4) Len() float32 { _ = "STUB: not implemented"; return 0 }

// LenSqr returns the vector's square length. This is equivalent to the sum of the squares of all elements.
func (v1 Vec4) LenSqr() float32 { _ = "STUB: not implemented"; return 0 }
