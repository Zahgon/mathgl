...
func Abs(a float32) float32 { _ = "STUB: not implemented"; return 0 }
...
func FloatEqual(a, b float32) bool { _ = "STUB: not implemented"; return false }
...
func FloatEqualThreshold(a, b, epsilon float32) bool {
	_ = "STUB: not implemented"
	// Handles the case of inf or shortcuts the loop when no significant error has accumulated
	return false
}

// If a or b are 0 or both are extremely close to it
...
func Clamp(a, low, high float32) float32 { _ = "STUB: not implemented"; return 0 }

// ClampFunc generates a closure that returns its parameter
// clamped to the range [low,high].
func ClampFunc(low, high float32) func(float32) float32 { _ = "STUB: not implemented"; return nil }
...
func IsClamped(a, low, high float32) bool { _ = "STUB: not implemented"; return false }

// SetMin sets a to b if a > b.
func SetMin(a, b *float32) { _ = "STUB: not implemented"; return }

// SetMax sets a to b if a < b.
func SetMax(a, b *float32) { _ = "STUB: not implemented"; return }
...
func Round(v float32, precision int) float32 { _ = "STUB: not implemented"; return 0 }
