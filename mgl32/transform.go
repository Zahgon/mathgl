...
//	[[0, 1, Ty]]
//	[[0, 0, 1 ]]
func Translate2D(Tx, Ty float32) Mat3 { _ = "STUB: not implemented"; return *new(Mat3) }
...
//	[[0, 0, 1, Tz]]
//	[[0, 0, 0, 1 ]]
func Translate3D(Tx, Ty, Tz float32) Mat4 { _ = "STUB: not implemented"; return *new(Mat4) }
...
// [[ 0     , 0     , scaleZ, 0 ]]
// [[ 0     , 0     , 0     , 1 ]]
func Scale3D(scaleX, scaleY, scaleZ float32) Mat4 { _ = "STUB: not implemented"; return *new(Mat4) }

// Scale2D creates a homogeneous 2D scaling matrix
// [[ scaleX, 0     , 0 ]]
// [[ 0     , scaleY, 0 ]]
// [[ 0     , 0     , 1 ]]
func Scale2D(scaleX, scaleY float32) Mat3 { _ = "STUB: not implemented"; return *new(Mat3) }

// ShearX2D creates a homogeneous 2D shear matrix along the X-axis
func ShearX2D(shear float32) Mat3 { _ = "STUB: not implemented"; return *new(Mat3) }

// ShearY2D creates a homogeneous 2D shear matrix along the Y-axis
func ShearY2D(shear float32) Mat3 { _ = "STUB: not implemented"; return *new(Mat3) }

// ShearX3D creates a homogeneous 3D shear matrix along the X-axis
func ShearX3D(shearY, shearZ float32) Mat4 { _ = "STUB: not implemented"; return *new(Mat4) }

// ShearY3D creates a homogeneous 3D shear matrix along the Y-axis
func ShearY3D(shearX, shearZ float32) Mat4 { _ = "STUB: not implemented"; return *new(Mat4) }

// ShearZ3D creates a homogeneous 3D shear matrix along the Z-axis
func ShearZ3D(shearX, shearY float32) Mat4 { _ = "STUB: not implemented"; return *new(Mat4) }
...
//	[[ 0         , 0         , 0         , 1 ]]
func HomogRotate3D(angle float32, axis Vec3) Mat4 { _ = "STUB: not implemented"; return *new(Mat4) }

// Extract3DScale extracts the 3d scaling from a homogeneous matrix
func Extract3DScale(m Mat4) (x, y, z float32) { _ = "STUB: not implemented"; return 0, 0, 0 }

// ExtractMaxScale extracts the maximum scaling from a homogeneous matrix
func ExtractMaxScale(m Mat4) float32 { _ = "STUB: not implemented"; return 0 }
