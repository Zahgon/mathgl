...
func NewMatrixFromData(src []float32, m, n int) *MatMxN { _ = "STUB: not implemented"; return nil }
...
func (mat *MatMxN) Trace() float32 { _ = "STUB: not implemented"; return 0 }
...
func (mat *MatMxN) Raw() []float32 { _ = "STUB: not implemented"; return nil }
...
func (mat *MatMxN) At(row, col int) float32 { _ = "STUB: not implemented"; return 0 }

// Set sets the element at the given row and column.
// This is garbage in/garbage out and does no bounds
// checking. If the computation happens to lead to an invalid
// element, it will be set; or it may panic.
func (mat *MatMxN) Set(row, col int, val float32) { _ = "STUB: not implemented"; return }
...
func (mat *MatMxN) Mul(dst *MatMxN, c float32) *MatMxN { _ = "STUB: not implemented"; return nil }
